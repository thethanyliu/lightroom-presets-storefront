  ...
  return (
    ...
    <div className="misc-inner-container">
      ...
      <p>
        ...
        Privacy applies to www.pnutpresets.com and PnutPresets and governs
        data collection and usage. For the purposes of this Privacy Policy,
        unless otherwise noted, all references to PnutPresets include
        www.pnutpresets.com and PnutPresets. The PnutPresets website for
        selling music devices & electronic headsets. By using the PnutPresets
      ...
      <p>
        ...
        our Site, PnutPresets may collect personally identifiable information,
        such as your:
      </p>
      <br />
      <ul>
        <li className="bullet-point">– First and Last Name</li>
        <li className="bullet-point">– Mailing Address </li>
        <li className="bullet-point">– E-mail Address </li>
      </ul>
      <br />
      <p>
        If you purchase PnutPresets’s products and services, we collect
      ...
      <p>
        ...
        PnutPresets’s public message boards, this information may be collected
        and used by others.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        PnutPresets collects and uses your personal information to operate its
        website(s) and deliver the services you have requested. PnutPresets
        may also use your personally identifiable information to inform you of
        other products or services available from PnutPresets and its
        affiliates.
      </p>
      <br />
      <p>
        Sharing Information with Third Parties PnutPresets does not sell, rent
        or lease its customer lists to third parties.
      </p>
      <br />
      <p>
        PnutPresets may share data with trusted partners to help perform
        ...
        these services to PnutPresets, and they are required to maintain the
        confidentiality of your information. PnutPresets may disclose your
        ...
        PnutPresets or the site; (b) protect and defend the rights or property
        of PnutPresets; and/or (c) act under exigent circumstances to protect
        the personal safety of users of PnutPresets, or the public.
      </p>
      <br />
      ...
      <p>
        ...
        within PnutPresets, in order to determine what PnutPresets services
        are the most popular. This data is used to deliver customized content
        and advertising within PnutPresets to customers whose behavior
        indicates that they are interested in a particular subject area.
      </p>
      <br />
      <ul>
        <li className="bullet-point">Facebook Pixel Data Tracking </li>
        <li className="bullet-point">Automatically Collected Information</li>
      </ul>
      <br />
      <p>
        Information about your computer hardware and software may be
        automatically collected by PnutPresets. This information can include:
      ...
      <br />
      <p>
        The PnutPresets website may use “cookies” to help you personalize your
      ...
      <p>
        ...
        personalize PnutPresets pages, or register with PnutPresets site or
        services, a cookie helps PnutPresets to recall your specific
        ...
        shipping addresses, and so on. When you return to the same PnutPresets
        website, the information you previously provided can be retrieved, so
        you can easily use the PnutPresets features that you customized.
      </p>
      <br />
      <p>
        ...
        features of the PnutPresets services or websites you visit.
      </p>
      <br />
      ...
      <p>
        ...
        access, use, or disclosure. PnutPresets uses the following methods for
        this purpose:
      </p>
      <br />
      <ul>
        <li className="bullet-point">– SSL Protocol</li>
      </ul>
      <br />
      <p>
      ...
      <br />
      <p>
        PnutPresets collects personally identifiable information from children
        under the age of thirteen. PnutPresets collects this information for
        the following reason(s):
      </p>
      <br />
      <ul>
        <li className="bullet-point">
          Tracking website user data & information during the signup process.{" "}
        </li>
      </ul>
      <br />
      <p>
        ...
        contact us using the information provided at the end of this Statement
        of Privacy.
      </p>
      <br />
      ...
      <br />
      <p>
        PnutPresets reserves the right to change this Privacy Policy from time
      ...
      <p>
        PnutPresets welcomes your questions or comments regarding this
        Statement of Privacy. If you believe that PnutPresets has not adhered
        to this Statement, please contact PnutPresets here.
      </p>
    </div>
  </div>
  );
