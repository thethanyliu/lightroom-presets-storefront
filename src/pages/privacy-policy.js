        ...
        <div className="misc-container">
          <div className="misc-inner-container">
            ...
            <p>
              ...
              Statement of Privacy applies to www.pnutpresets.com and
              PnutPresets and governs data collection and usage. For the
              purposes of this Privacy Policy, unless otherwise noted, all
              references to PnutPresets include www.pnutpresets.com and
              PnutPresets. The PnutPresets website for selling music devices &
              electronic headsets. By using the PnutPresets website, you consent
            ...
            <p>
              ...
              on our Site, PnutPresets may collect personally identifiable
            ...
            <p>
              ...
              PnutPresets’s public message boards, this information may be
            ...
            <p>
              ...
              PnutPresets may also use your personally identifiable information
              to inform you of other products or services available from
              PnutPresets and its affiliates.
            </p>
            <br />
            <p>
              Sharing Information with Third Parties PnutPresets does not sell,
            ...
            <p>
              ...
              to provide these services to PnutPresets, and they are required to
              maintain the confidentiality of your information. PnutPresets may
              ...
              legal process served on PnutPresets or the site; (b) protect and
              defend the rights or property of PnutPresets; and/or (c) act under
            ...
            <br />
            <p>
              PnutPresets may keep track of the websites and pages our users
              visit within PnutPresets, in order to determine what PnutPresets
              services are the most popular. This data is used to deliver
              customized content and advertising within PnutPresets to customers
            ...
            <p>
              ...
              automatically collected by PnutPresets. This information can
              ...
              to provide general statistics regarding use of the PnutPresets
              website.
            </p>
            <br />
            ...
            <p>
              ...
              if you personalize PnutPresets pages, or register with PnutPresets
              site or services, a cookie helps PnutPresets to recall your
              ...
              same PnutPresets website, the information you previously provided
              can be retrieved, so you can easily use the PnutPresets features
              that you customized.
            </p>
            <br />
            <p>
              ...
              the interactive features of the PnutPresets services or websites
              you visit.
            </p>
            <br />
            <h2 className={subHeadingStyle}>
            ...
            <p>
              ...
              access, use, or disclosure. PnutPresets uses the following methods
              for this purpose:
            </p>
            <br />
            <ul>
            ...
            <p>
              ...
              children under the age of thirteen. PnutPresets collects this
              information for the following reason(s):
            </p>
            <br />
            <ul>
              <li className="bullet-point">
                Tracking website user data & information during the signup
                process.{" "}
              </li>
            </ul>
            <br />
            <p>
              ...
              guardian for permission to use this website. If you are a parent
              and you have questions regarding our data collection practices,
            ...
            <p>
              ...
              you open an email from PnutPresets or click on a link therein.
            </p>
            <br />
            ...
            <p>
              ...
              Statement of Privacy. If you believe that PnutPresets has not
              adhered to this Statement, please contact PnutPresets here.
            </p>
          </div>
        </div>
      </Layout>
