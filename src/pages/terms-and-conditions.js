    ...
    <div className="misc-container">
      <div className="misc-inner-container">
        ...
        <p>
          ...
          graphics, logos, images, and software, is the property of PnutPresets
          ...
          content on the Website without prior written consent from PnutPresets.
        </p>
        <br />
        <h2>User Conduct</h2>
        <br />
        ...
        <ul>
          ...
          <li className="bullet-point">
            c. Refrain from transmitting any content that is unlawful, harmful,
        ...
        <p>
          ...
          services. You access and use these third-party websites or services at
          your own risk.
        </p>
        <br />
        ...
        <p>
          ...
          any warranties, express or implied. PnutPresets does not guarantee the
          accuracy, reliability, or availability of the Website. You use the
        ...
        <p>
          ...
          revise these terms and conditions by posting an updated version on the
          Website. Continued use of the Website after any such changes shall
